...
public class TestLinkIntegration {
	...
	public static String DEV_KEY  = "5edfe6811de33ab8f8db475169bcdb4b"; // Replace your TestLink API Key here
	public static String TESTLINK_URL = "http://localhost/testlink-1.9.19/lib/api/xmlrpc/v1/xmlrpc.php"; 
